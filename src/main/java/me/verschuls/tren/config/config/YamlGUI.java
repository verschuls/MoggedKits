...
public class YamlGUI {
    ...
    public static class Menu {
        ...
        @Comment({"Kit icon positions - each kit's weight maps here", "weight 0 -> kit_slots[0], weight 1 -> kit_slots[1], etc.", "More kits than slots = ArrayIndexOutOfBounds mogs your console"})
