...
public class GUI implements Listener {
    ...
    Inventory clone_inv(Player p) {
        Inventory inv = Bukkit.createInventory(inventory.getHolder(), inventory.getSize(), TextUtils.format(Placeholder.get().parse(p, title)));
    ...
    public static class Builder {
        ...
        public GUI.Builder clickSound(String sound, Integer volume) {
            this.holder.clickSound = Sound.sound(Key.key(sound), Sound.Source.MASTER, (volume/100F), 1f);
            return this;
        }
