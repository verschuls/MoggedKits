...
public class Placeholder {
    ...
    private Placeholder() {
        if (MoggedKits.getInstance().getServer().getPluginManager().isPluginEnabled("PlaceholderAPI")) {
    ...
    public static Placeholder get() {
        return INSTANCE == null ? INSTANCE = new Placeholder() : INSTANCE;
    }
    ...
    public String parse(@Nullable Player player, String text) {
        ...
        return papi ? PlaceholderAPI.setPlaceholders(player, builder.toString()) : builder.toString();
    }
